        ...
        builder: (context, provider, child)
    {
      return Column(
        children: [
                      ...
                      onChanged: (d) {
                        ...
                        if (d!.isNotEmpty) {
                          ...
                          //================vecCar==========================
                            ...
                            case "سيارة صغيرة":
                              provider.vecCar(showVechError, d,showError);
                              //provider.notifyListeners();
                              break;

                            case "سيارة كبيرة":
                              provider.vecLargeCar(showVechError, d,showError);
                              break;
                            case "ونيت":
                              provider.vecWent(showVechError, d,showError);
                              break;
                            case "شاحنة":
                              validationService.vecVan(showVechError, d,showError);
                              break;
                            case "دراجة نارية":
                              validationService.vecPickUp(showVechError, d,showError);
                              break;
                            case "دراجة هوائية":
          ...
          ListBodyTypeVec(title:ConstantsVec.smallCarVec ,listVec:  VehModel.vecCar,x: 0,),
          ListBodyTypeVec(title:ConstantsVec.van,listVec:  VehModel.vecVan,x: 1),
          ListBodyTypeVec(title:ConstantsVec.went,listVec:  VehModel.vecWanet,x: 2),
          ListBodyTypeVec(title:ConstantsVec.largeCarKey,listVec:  VehModel.largeCar,x: 3),
          ListBodyTypeVec(title:ConstantsVec.pickUp,listVec:  VehModel.pickUp,x: 4),
          ListBodyTypeVec(title:ConstantsVec.bicyle,listVec:  VehModel.bicycle,x: 5),
          ListBodyTypeVec(title:ConstantsVec.escooter,listVec:  VehModel.eScooter,x: 6),
